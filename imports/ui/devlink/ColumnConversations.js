...
import { CardCommonWords } from "./CardCommonWords";
import * as _utils from "./utils";
import _styles from "./ColumnConversations.module.css";
...
export function ColumnConversations({ as: _Component = _Builtin.Block }) {
    _interactions.useInteractions(_interactionsData, _styles);

    return (
        <_Component className={_utils.cx(_styles, "topic-page-column-div", "conversation")} tag="div">
            <_Builtin.Block className={_utils.cx(_styles, "topic-page-column")} tag="div">
                                ...
                                <_Builtin.Block className={_utils.cx(_styles, "text-info", "align-left")} tag="div">
                                    <_Builtin.Block className={_utils.cx(_styles, "text-info-col")} tag="div">
                                        <_Builtin.Block tag="div">
                                            <_Builtin.Strong>{"1760"}</_Builtin.Strong>
                                            {" conversations reltaed to"}
                                            <_Builtin.Strong>{" Want wifi internet"}</_Builtin.Strong>
                                        </_Builtin.Block>
                                    </_Builtin.Block>
                                </_Builtin.Block>
                ...
                <_Builtin.Block className={_utils.cx(_styles, "btn-close")} data-w-id="b034caf1-745b-f1f4-52ce-c738a21ac809" tag="div">
                    <_Builtin.Image
                        loading="lazy"
                        width="auto"
                        height="auto"

...
export const NavbarContainer = React.forwardRef(function NavbarContainer({ children, ...props }, ref) {
...
export const NavbarBrand = React.forwardRef(function NavbarBrand({ className = "", ...props }, ref) {
    return <Link {...props} className={cj(className, "w-nav-brand")} ref={ref} />;
});
export const NavbarMenu = React.forwardRef(function NavbarMenu({ tag = "nav", className = "", ...props }, ref) {
...
export const NavbarLink = React.forwardRef(function NavbarLink({ className = "", ...props }, ref) {
    const { isOpen } = React.useContext(NavbarContext);
    return <Link {...props} className={cj(className, "w-nav-link", isOpen && "w--nav-link-open")} ref={ref} />;
});
export const NavbarButton = React.forwardRef(function NavbarButton({ tag = "div", className = "", ...props }, ref) {

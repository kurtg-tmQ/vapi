...
export const FormTextInput = React.forwardRef(function FormTextInput({ className = "", ...props }, ref) {
...
export const FormTextarea = React.forwardRef(function FormTextarea({ className = "", ...props }, ref) {
...
export const FormInlineLabel = React.forwardRef(function FormInlineLabel({ className = "", ...props }, ref) {
...
export const FormCheckboxWrapper = React.forwardRef(function FormCheckboxWrapper({ className = "", ...props }, ref) {
...
export const FormRadioWrapper = React.forwardRef(function FormRadioWrapper({ className = "", ...props }, ref) {
    return React.createElement("label", {
...
export const FormBooleanInput = React.forwardRef(function FormBooleanInput(
    ...
    if (inputType === "custom") {
        ...
        }${isFocusedVisible ? ` ${FOCUSED_CLASS} ${FOCUSED_VISIBLE_CLASS}` : ""} ${customClassName ?? ""}`;
...
export const FormCheckboxInput = React.forwardRef(function FormCheckboxInput({ className = "", ...props }, ref) {
    return <FormBooleanInput {...props} ref={ref} type="checkbox" className={className + " w-checkbox-input"} />;
});
export const FormRadioInput = React.forwardRef(function FormRadioInput({ className = "", ...props }, ref) {
    return <FormBooleanInput {...props} ref={ref} type="radio" className={className + " w-radio-input"} />;
});
...
export const FormFileUploadWrapper = React.forwardRef(function FormFileUploadWrapper({ maxSize = MAX_FILE_SIZE_DEFAULT, ...props }, ref) {
...
export const FormFileUploadDefault = React.forwardRef(function FormFileUploadDefault({ className = "", ...props }, ref) {
...
export const FormFileUploadInput = React.forwardRef(function FormFileUploadInput({ className = "", ...props }, ref) {
...
export const FormFileUploadLabel = React.forwardRef(function FormFileUploadLabel({ className = "", ...props }, ref) {
    return React.createElement("label", {
...
export const FormFileUploadText = React.forwardRef(function FormFileUploadText({ className = "", ...props }, ref) {
    return React.createElement("div", {
...
export const FormFileUploadInfo = React.forwardRef(function FormFileUploadInfo({ className = "", ...props }, ref) {
    return React.createElement("div", {
...
export const FormFileUploadUploading = React.forwardRef(function FormFileUploadUploading({ className = "", ...props }, ref) {
    return React.createElement("div", {
...
export const FormFileUploadUploadingBtn = React.forwardRef(function FormFileUploadUploadingBtn({ className = "", ...props }, ref) {
    return React.createElement("div", {
...
export const FormFileUploadUploadingIcon = React.forwardRef(function FormFileUploadUploadingIcon({ className = "", ...props }, ref) {
    return React.createElement(
        "svg",
        {
...
export const FormFileUploadSuccess = React.forwardRef(function FormFileUploadSuccess({ className = "", ...props }, ref) {
    const { files, error } = React.useContext(FileUploadContext);
    return React.createElement("div", {
...
export const FormFileUploadFile = React.forwardRef(function FormFileUploadFile({ className = "", ...props }, ref) {
    return React.createElement("div", {
...
export const FormFileUploadFileName = React.forwardRef(function FormFileUploadFileName({ className = "", ...props }, ref) {
...
export const FormFileUploadError = React.forwardRef(function FormFileUploadError({ className = "", ...props }, ref) {
...
export const FormFileUploadErrorMsg = React.forwardRef(function FormFileUploadErrorMsg({ errors, className = "", ...props }, ref) {
    const { error } = React.useContext(FileUploadContext);
    return React.createElement(
        "div",
        {
...
export const FormButton = React.forwardRef(function FormButton({ className = "", value, ...props }, ref) {
    return React.createElement("input", {
        ...props,
        ref,
        type: "submit",
...
export const SearchInput = React.forwardRef(function SearchInput({ className = "", ...props }, ref) {
    return React.createElement("input", {
        ...props,
        type: "text",
        className: className + " w-input",
...
export const SearchButton = React.forwardRef(function SearchButton({ value = "", className = "", ...props }, ref) {
    return React.createElement("input", {
        ...props,
        type: "submit",
        value,
...
export const FormSuccessMessage = React.forwardRef(function FormSuccessMessage({ className = "", ...props }, ref) {
    return React.createElement("div", {
...
export const FormErrorMessage = React.forwardRef(function FormErrorMessage({ className = "", ...props }, ref) {
    return React.createElement("div", {
...
export const FormSelect = React.forwardRef(function FormSelect({ options, className = "", ...props }, ref) {
    return React.createElement(
        "select",
        { className: className + " w-select", ...props, ref },
        options.map(({ v, t }, index) => React.createElement("option", { key: index, value: hasValue(v) ? v : "" }, hasValue(t) ? t : ""))
    );
});
export const FormReCaptcha = React.forwardRef(function FormReCaptcha({ siteKey = "", theme = "light", size = "normal" }, ref) {
    React.useEffect(() => {
        loadScript("https://www.google.com/recaptcha/api.js", {
            cacheRegex: /(http|https):\/\/(www)?.+\/recaptcha/
        });
    }, []);
    return <div ref={ref} className="g-recaptcha" data-sitekey={siteKey} data-theme={theme} data-size={size} />;
});

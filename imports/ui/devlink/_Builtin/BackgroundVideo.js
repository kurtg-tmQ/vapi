...
export const BackgroundVideoWrapper = React.forwardRef(function BackgroundVideoWrapper(
    { tag = "div", className = "", autoPlay = true, loop = true, sources = [], posterImage = "", children },
    ref
) {
...
export const BackgroundVideoPlayPauseButton = React.forwardRef(function BackgroundVideoPlayPauseButton({ children, className }, ref) {
...
export const BackgroundVideoPlayPauseButtonPlaying = React.forwardRef(function BackgroundVideoPlayPauseButtonPlaying({ children }, ref) {
...
export const BackgroundVideoPlayPauseButtonPaused = React.forwardRef(function BackgroundVideoPlayPauseButtonPaused({ children }, ref) {
    const { isPlaying } = React.useContext(BgVideoContext);
    return (
        <span hidden={isPlaying} ref={ref}>
            {children}

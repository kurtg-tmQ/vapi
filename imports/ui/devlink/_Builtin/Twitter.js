...
export const Twitter = React.forwardRef(function Twitter(
    { className = "", url = "https://webflow.com", mode = "tweet", size = "m", text = "Check out this site", ...props },
    ref
) {
    ...
    return <div {...props} className={className + " w-widget w-widget-twitter"} ref={innerRef} />;
});

...
export const TabsMenu = React.forwardRef(function TabsMenu({ tag = "div", className = "", ...props }, ref) {
...
export const TabsLink = React.forwardRef(function TabsLink({ className = "", children, ...props }, ref) {
...
export const TabsContent = React.forwardRef(function TabsContent({ tag = "div", className = "", ...props }, ref) {
    return React.createElement(tag, {
        ...props,
...
export const TabsPane = React.forwardRef(function TabsPane({ tag = "div", className = "", ...props }, ref) {

...
export const SliderWrapper = React.forwardRef(function SlideWrapper({ className = "", ...props }, ref) {
    ...
    return (
        ...
        >
            <div {...swipeHandlers} className={cj(className, "w-slider")} role="region" aria-label="carousel" ref={ref}>
                {props.children}
            </div>
        </SliderContext.Provider>
    );
...
export const SliderMask = React.forwardRef(function SliderMask({ className = "", children, ...props }, ref) {
...
export const SliderArrow = React.forwardRef(function SliderArrow({ className = "", dir = "left", children, ...props }, ref) {
    const {
        goToNextSlide,
        goToPreviousSlide,
        hideArrows,
...
export const SliderNav = React.forwardRef(function SliderNav({ className = "", ...props }, ref) {
    ...
    const dots = [...Array(slideAmount).keys()].map((_, i) => {
        return <SliderDot key={i} index={i} focusedDot={focusedDot} handleFocus={handleFocus} setFocusedDot={setFocusedDot} />;
    });
    return (
        <div
            {...props}
